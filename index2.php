...
?>
<!DOCTYPE html>
<html lang="pt" class="photography-demo-3">    
    <head>
        ...
        <?php if ($control[0] != "noticias" && $control[0] != "imovel"):?>
        ...
        <?php 
        elseif ($control[0] == "noticias" && isset($control[2]) || $control[0] == "imovel"): 
            include_once $_SERVER['DOCUMENT_ROOT'] . '/backend/lib/App/Site/head.phtml';           
        endif; ?> 
