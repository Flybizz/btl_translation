...
$uploadDir = $_SERVER['DOCUMENT_ROOT'].'/images/produto/galeria/';
// Set the allowed file extensions
$fileTypes = array('jpg', 'jpeg', 'gif', 'png','pdf','doc','docx','xls','xlsx','txt'); // Allowed file extensions
...
if (!empty($_FILES) && $_POST['token'] == $verifyToken) {
	...
	$fileParts = pathinfo($_FILES['Filedata']['name']);
  	if (in_array(strtolower($fileParts['extension']), $fileTypes)) {
			...
			$nomeimg = $name_file."_".date("s") .".". $format;
