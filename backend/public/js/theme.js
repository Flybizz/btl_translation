...
(function($) {
	...
	$items.find('> a').on('click', function( ev ) {
		...
		//caso o user faça a pesquisa e posteriormente clique no expand para ver outras opções, é necessáro apresentar os elementos previamente escondidos
		if($anchor.parent().hasClass("nav-expanded")){
			$anchor.parent().find("ul,li").fadeIn();
		}
